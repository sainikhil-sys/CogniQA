...
export default function GlobalError({
  ...
  return (
    <html>
      <body className="min-h-screen bg-[#050505] text-zinc-100 flex flex-col items-center justify-center p-6 font-sans">
        <div className="max-w-md w-full text-center space-y-6 bg-zinc-950 border border-zinc-900 rounded-xl p-8 shadow-2xl">
          ...
          <div className="space-y-2">
            <h1 className="text-xl font-bold tracking-tight text-white">System Error Caught</h1>
            <p className="text-zinc-500 text-xs leading-normal">
              A critical execution error has been intercepted and logged to Sentry telemetry nodes.
            </p>
          </div>
